...
\hypersetup{
            pdftitle={A Liturgy Resource from Warhorn Media},
            pdfauthor={Warhorn Media},
            pdfborder={0 0 0},
            breaklinks=true}
...
\addcontentsline{toc}{chapter}{Liturgy}
...
\addcontentsline{toc}{section}{From the Pastor}
...
\addcontentsline{toc}{section}{Responsive Calls}

\emph{\emph{Pastor:}} Blessed are You, O Lord God of Israel our father,
forever and ever.

\emph{\emph{Congregation}}: Yours, O Lord, is the greatness and the
...
\emph{\emph{Pastor}}: Both riches and honor come from You, and You rule
over all, and in Your hand is power and might; and it lies in Your hand
